...
int main()
    ...
    {
    hotel_database data;
  /*  strcpy(data.name,"Amit");
    strcpy(data.address,"Beta-1");
    strcpy(data.city,"Noida");
    strcpy(data.st,"UP");
    strcpy(data.zip,"201308");
    strcpy( data.phone,"4343524");
    */
    int choice;
    cout << ".............................." << endl;
...
void load_data(hotel_database data)
    ...
    cout << "Address: " << endl;
    cin >> data.address;
    //cin.get(data.address, 18);
    //cin.ignore(80, '\n');
    cout << "\n";
    cout << "City: " << endl;
    cin >> data.city;
    //cin.get(data.city, 28);
    //cin.ignore(80, '\n');
    cout << "\n";
    cout << "State: " << endl;
    cin >> data.state;
