 ...
 /** 
  *
  * Summary description for viewprofile //new Color(196, 212, 242) 
  * 
  */ 
 ...
 { 
	...
	private JButton jButton13;//logout
	private JButton jButton14;//bday1
 ...
 //	private JTextArea jTextArea1; 
 	...
 	{   
 	    jButton1=new JButton("Edit Profile"); 	
 	    jButton2=new JButton("View Friends");
 	   jButton3=new JButton("Next");
 	    ...
 	    jButton14=new JButton();//bday
 	    jButton15=new JButton();
 	    jButton16=new JButton();
 	    //upper
 	    jButton8=new JButton("Refresh");
 	    jButton9=new JButton("Search");
 	    jButton10=new JButton("Scrapbook");
 		...
 		jLabel16 = new JLabel();
 		jLabel17 = new JLabel();
 		jLabel18 = new JLabel("NO PHOTO");//bday
 		jLabel19 = new JLabel("NO PHOTO");
 		jLabel20 = new JLabel("NO PHOTO");
 		
 	    
 		new Client("photo"+userdata);
 	//	photo.setIcon(new ImageIcon("c:/orkut_java/photos/"+orkut.currentuser+".jpg")); 
 	//this is written below		
 		
 		//photo label order is 2,3,16,4,5,17
 		//friends order is  4,5,11,6,7,12
 	/*	jLabel2.setIcon(new ImageIcon("c:/orkut_java/photos/"+orkut.currentuser+".jpg"));
 	...
 	//	jLabel16.setIcon(new ImageIcon("c:/orkut_java/test.jpg"));
 		/*jButton4=new JButton();
 	    jButton5=new JButton();
 	    jButton6=new JButton();
 	    jButton7=new JButton();*/
 		...
 		/*
 		jLabel19.setIcon(new ImageIcon("c:/orkut_java/photos/"+arr[0]+".jpg"));
 		jLabel20.setIcon(new ImageIcon("c:/orkut_java/photos/"+arr[0]+".jpg"));*/
 	    ...
 	    int ctr=0; 
 		for(int i=0;i<abc;i++)
 		    { isbdday ibd=new isbdday();
 		        String dbd="";
 		        dbd=c66.Client("select dob from logins where username='"+arr12[i]+"';",0);
 		        ...
 		        if(ibd.calc(dbd)&&ctr<3)
 		          {
 		          	...
 		          	switch(ctr)
 		                  {
 		                  	case 0:jLabel18.setIcon(new ImageIcon("c:/orkut_java/photos/"+arr12[i]+".jpg"));
 		                  	       jButton14.setText(arr12[i]);
 		                  	       jTextField17.setText(dbd); 
 		                  	       jLabel18.setVisible(true);
 		                  	       jButton14.setVisible(true);
 		                  	       jTextField17.setVisible(true);
 		                  	        break;
 		                  	case 1:jLabel19.setIcon(new ImageIcon("c:/orkut_java/photos/"+arr12[i]+".jpg"));
 		                  	       jButton15.setText(arr12[i]);
 		                  	       jTextField18.setText(dbd); 
 		                  	       jLabel19.setVisible(true);
 		                  	       jButton15.setVisible(true);
 		                  	       jTextField18.setVisible(true);
 		                  	          break;
 		                  	case 2:jLabel20.setIcon(new ImageIcon("c:/orkut_java/photos/"+arr12[i]+".jpg"));
 		                  	       jButton16.setText(arr12[i]);
 		                  	       jTextField19.setText(dbd); 
 	...
 	//	new Client("photo"+userdata);
 		...
 		*/
 		...
 		jTextField1.setBackground(new Color(239, 122, 247)); 
 		jTextField1.setText("                    NO OF SCRAPS = "+c.strrecv); 
 		...
 		// jTextField17 
 		// 
 		jTextField17.setBackground(new Color(239, 122, 247)); 
 		jTextField17.setEditable(false); 
 		jTextField17.addActionListener(new ActionListener() { 
 			public void actionPerformed(ActionEvent e) 
 			{ 
 				jTextField17_actionPerformed(e); 
 			} 
 		...
 		// jTextField18 
 		// 
 		jTextField18.setBackground(new Color(140, 152, 236)); 
 		jTextField18.setEditable(false); 
 		jTextField18.addActionListener(new ActionListener() { 
 			public void actionPerformed(ActionEvent e) 
 			{ 
 				jTextField18_actionPerformed(e); 
 			} 
 		...
 		// jTextField19 
 		// 
 		jTextField19.setBackground(new Color(239, 122, 247)); 
 		jTextField19.setEditable(false); 
 		jTextField19.addActionListener(new ActionListener() { 
 			public void actionPerformed(ActionEvent e) 
 			{ 
 				jTextField19_actionPerformed(e); 
 			} 
 		...
 		addComponent(contentPane, jButton1, 31,160 ,96,15); 
 	    //photos label
 		...
 		//bday
 		addComponent(contentPane, jLabel18, 600,300,100,100);
 		addComponent(contentPane, jLabel19, 600,440,100,100);
 		addComponent(contentPane, jLabel20, 600,580,100,100);
 		...
 		//bday
 		addComponent(contentPane, jButton14, 600,405,100,20);
 		addComponent(contentPane, jButton15, 600,545,100,20);
 		addComponent(contentPane, jButton16, 600,685,100,20);
 		
 		
 		addComponent(contentPane, jButton10, 31,180,96,15);
 		 
 		addComponent(contentPane, abtme1, 262,248,326,80); 
 	    	addComponent(contentPane, jTextField1, 140,148,364,46); 
 		...
 		//bday
 	    addComponent(contentPane, jTextField17, 725,340,120,22);   
 	 	addComponent(contentPane, jTextField18, 725,480,120,22); 
 		addComponent(contentPane, jTextField19, 725,600,120,22); 
 		...
 		Client c2=new Client("chkfr"+userdata);//check for invitation for frnd
 		 start =0;
 		 int temp1;
 		 int friends=0;
 		 int last=0;
          ...
          //System.out.println("*******in chkfr***** frnds="+friends);              
           ...
           while(start<last)
          	{
          		if((cc=c2.strrecv.indexOf("#",start))!=-1)
                         	   { temp=c2.strrecv.substring(start,cc);
                                 ...
                                 if((x=temp.lastIndexOf("*"))!=-1)
                             	 temp=temp.substring(x+1,temp.length());
                             	 //System.out.println("*******in chkfr a user extracted= "+temp+" count= "+count);
                             	 brr[count++]  =temp; 
          ...
          //System.out.println("*******in chkfr aaray content="+brr[i]);  
 		 if(friends!=0)
 		...
 		this.setTitle(orkut.currentuser+"'s PROFILE"); 
 ...
 /*
 	...
 	*/
 	...
 	private void jTextField17_actionPerformed(ActionEvent e) 
 	{ 
 		//System.out.println("\njTextField17_actionPerformed(ActionEvent e) called."); 
 		// TODO: Add any handling code here 
  
 	} 
  
 
 	private void jTextField18_actionPerformed(ActionEvent e) 
 	{ 
 		//System.out.println("\njTextField18_actionPerformed(ActionEvent e) called."); 
 		// TODO: Add any handling code here 
  
 	} 
  
 	private void jTextField19_actionPerformed(ActionEvent e) 
 	{ 
 		//System.out.println("\njTextField19_actionPerformed(ActionEvent e) called."); 
 		// TODO: Add any handling code here 
 	...
 	{ 
 		//System.out.println("\njButton14_actionPerformed(ActionEvent e) called."); 
 		// TODO: Add any handling code here 
 	      
        new view_others(jButton14.getText());
        this.setVisible(false);
 	} 
 	...
 	{ 
 		//System.out.println("\njButton15_actionPerformed(ActionEvent e) called."); 
 		// TODO: Add any handling code here 
 	      
            
        new view_others(jButton15.getText());
        this.setVisible(false);
 	} 
 	...
 	{ 
 		//System.out.println("\njButton16_actionPerformed(ActionEvent e) called."); 
 		// TODO: Add any handling code here 
 	      
           
        new view_others(jButton16.getText());
        this.setVisible(false);
 	} 
