...
public class MyCalc extends JInternalFrame implements ActionListener {
//jar cf jar-file input-file(s);
   ...
   private JPanel textPanel, buttonPanel, functionPanel ;
   private Container c ;
   private Font         font;
   ...
   MyCalc() {
      ...
      super( "Calculator",false,false,false,false );
      setup() ;
   ...
   private void setup()   {
      ...
      bCEnt.setBackground(new Color(255,255,255) ) ;
      bCEnt.setForeground( Color.gray );
      bCAll.addActionListener( this );
      bCAll.setBackground(new Color(255,255,255) ) ;
      bCAll.setForeground( Color.gray );
      bMPlus.addActionListener( this );
      bMPlus.setBackground(new Color(255,255,255) ) ;
      bMPlus.setForeground( Color.gray );
      bMMinus.addActionListener( this );
      bMMinus.setBackground(new Color(255,255,255) ) ;
      bMMinus.setForeground( Color.gray );
      bFact.addActionListener( this );
      bFact.setBackground(new Color(255,255,255) ) ;
...
//      c.add( exitPanel , BorderLayout.SOUTH ) ;
      bExit   = new JButton( "Exit" ) ;
      bExit.setFont( new Font("Sanserif", Font.BOLD, 8 ) );
...
//      bAbout.setForeground( Color.gray );
