...
// and writing)
#define DDRE _SFR_IO8(0x04)
#define DDRF _SFR_IO8(0x04)
#define PORTE _SFR_IO8(0x05)
#define PORTF _SFR_IO8(0x05)
#define PINE _SFR_IO8(0x06)
#define PINF _SFR_IO8(0x06)
