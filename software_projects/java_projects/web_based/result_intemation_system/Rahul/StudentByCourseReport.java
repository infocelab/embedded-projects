...
class StudentByCourseReport extends JFrame
{
	...
	StudentByCourseReport()
	{
		...
		JLabel l=new JLabel("<html><font size=6 color=#800080><i>Student Report");
		...
		try
		{
			...
			if(cours!=null)
			{
				...
				DefaultTableModel model=new DefaultTableModel(new String[]{"SCode","Name","Last Name","Date Of Joining"},row);
